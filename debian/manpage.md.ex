% custom-theme(SECTION) | User Commands
%
% "February 21 2024"
...
custom-theme - program to do something

# SYNOPSIS

**custom-theme** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**custom-theme** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **custom-theme** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**custom-theme** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    custom-theme. See **foo.conf**(5) for further details.
...
**custom-theme** provides some return codes, that can be used in scripts:
